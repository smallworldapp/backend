...
//{
//    public class WorldStatusValidatorTest : TestBase
//    {
//        public static IEnumerable<WorldStatus> CreateValid()
//        {
//            yield return WorldStatus.Applying;
//            yield return WorldStatus.Deleted;
//            yield return WorldStatus.Passed;
//            yield return WorldStatus.Pending;
//            yield return WorldStatus.Rejected;
//        }
//
//        public static IEnumerable<WorldStatus> CreateInvalid()
//        {
//            yield return WorldStatus.ERROR;
//        }
//
...
//        public async Task Valid(WorldStatus value)
//        {
...
//        public async Task Invalid(WorldStatus value)
//        {
//            using (var provider = CreateProvider())
//            using (var scope = provider.CreateScope())
//            {
